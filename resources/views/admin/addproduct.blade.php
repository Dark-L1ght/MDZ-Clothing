...
@endif
            <div class="row">
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Menambahkan Produk</h4>
                    <p class="card-description"> Isi form berikut untuk menambahkan produk ke toko </p>
                    <form id="add" class="forms-sample" action="{{ url('/tambahproduk') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                      ...
                      <div class="form-group">
                        ...
                        <textarea form="add" class="form-control" id="description" name="description" rows="4"></textarea>
                      </div>
